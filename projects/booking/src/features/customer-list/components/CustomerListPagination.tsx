...
export function CustomerListPagination({ total }: { total: number }) {
  const page = useCustomerListStore((s) => s.listPage)
  const pageSize = useCustomerListStore((s) => s.listPageSize)
  const setListPage = useCustomerListStore((s) => s.setListPage)
  const setListPageSize = useCustomerListStore((s) => s.setListPageSize)
